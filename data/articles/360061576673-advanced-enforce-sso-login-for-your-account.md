...
**Notes:** You will have to use the official [https://app.optisigns.com/](https://app.optisigns.com/) to log in to enforce SSO. You cannot use a custom domain with Enforce SSO, as the custom domain URL does not have an SSO login.

* * *

## Setting Up SAML SSO Enforcement (MS Entra ID, Okta, OneLogin, Google Workspace)

<table style="width: 100%;"><tbody><tr><td><strong>NOTE: </strong>&nbsp;This feature is available to <strong>Pro Plus</strong>, <strong>Engage</strong>, and <strong>Enterprise </strong>plan users.</td></tr></tbody></table>

...
Go to our portal: [https://app.optisigns.com](https://app.optisigns.com)
...
<table style="border-collapse: collapse; width: 100%;" border="1"><tbody><tr><td class="wysiwyg-text-align-center" style="width: 100%;"><strong>NOTE</strong></td></tr><tr><td style="width: 100%;">As of July 2025, Microsoft has created a limitation which only allows Excel sheets under&nbsp;<strong>1 MB&nbsp;</strong>to be uploaded in this manner. If you have an Excel sheet you'd like to display that is larger than 1 megabyte, we suggest&nbsp;<strong>Option 1</strong>.</td></tr></tbody></table>
...
<table style="border-collapse: collapse; width: 100%;" border="1"><tbody><tr><td class="wysiwyg-text-align-center" style="width: 100%;"><strong>IMPORTANT</strong></td></tr><tr><td style="width: 100%;">The total file size for an OptiSigns Excel app <strong>cannot exceed 105 MB </strong>and still display onscreen. This is due to a limitation by Microsoft.</td></tr></tbody></table>

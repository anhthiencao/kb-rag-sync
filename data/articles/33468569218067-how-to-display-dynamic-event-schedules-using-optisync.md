...
<table style="width: 100%;"><colgroup><col></colgroup><tbody><tr><td><strong>NOTE: </strong>OptiSync and dynamic data mapping are exclusive to <strong>Pro Plus</strong> plans and above.</td></tr></tbody></table>
...
<table style="width: 100%;"><colgroup><col></colgroup><tbody><tr><td><strong>NOTE: </strong>This formula will only work if both the Date and Time are present in the Event Time cell. The “B2” part should match the actual event time, i.e. B3 for Zumba in the Example.</td></tr></tbody></table>
...
![firefox\_69WJbcItk0.gif](https://support.optisigns.com/hc/article_attachments/42920711657491)

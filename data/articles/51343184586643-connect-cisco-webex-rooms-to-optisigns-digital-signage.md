...
<table><thead><tr><th>Scope</th><th>What it's for</th></tr></thead><tbody><tr><td><code>spark-admin:devices_read</code></td><td>Reads the Webex Rooms inventory and device-group membership.</td></tr><tr><td><code>spark-admin:devices_write</code></td><td>Pushes the signage URL to each Webex device via device configurations.</td></tr><tr><td><code>spark:xapi_commands</code></td><td>Sends xAPI commands (refresh, restart app) over Service App tokens.</td></tr><tr><td><code>spark:xapi_statuses</code></td><td>Reads device health signals (online state, peripheral status).</td></tr><tr><td><code>spark-admin:organizations_read</code></td><td>Reads org metadata to sanity-check the Org ID you paste.</td></tr></tbody></table>
...
<table><thead><tr><th>Setting</th><th>What it does</th><th>Recommended</th></tr></thead><tbody><tr><td><strong>Interaction Mode</strong></td><td>Whether touch on a Board/Desk wakes the device or interacts with content</td><td><strong>Non-interactive (kiosk)</strong> for lobby/info screens; <strong>Interactive (touch)</strong> for kiosk-style content</td></tr><tr><td><strong>Auto-refresh</strong></td><td>How often the device reloads the signage URL (<code>0 = never</code>)</td><td>30 minutes (default)</td></tr><tr><td><strong>Mute</strong></td><td>Whether videos play with sound</td><td>Off (default)</td></tr><tr><td><strong>Enable</strong></td><td>Master on/off for digital signage — disabling preserves the URL so you can re-enable later</td><td>On</td></tr></tbody></table>

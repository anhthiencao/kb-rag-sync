...
<table class="wysiwyg-table-resized"><colgroup><col style="width: NaN%;"></colgroup><tbody><tr><td><strong>NOTE:&nbsp;</strong> This feature is available to <strong>Pro Plus</strong>, <strong>Engage</strong>, and <strong>Enterprise </strong>plan users.</td></tr></tbody></table>
...
<table class="wysiwyg-table-resized"><colgroup><col style="width: NaN%;"></colgroup><tbody><tr><td><strong>NOTE: </strong>Without configuring this, all users will be assigned User Role and Default Team. You will have to manually change their roles and teams within the OptiSigns app.</td></tr></tbody></table>
...
<table class="wysiwyg-table-resized"><colgroup><col style="width: NaN%;"></colgroup><tbody><tr><td><strong>NOTE: </strong>If you map an SAML group to a Team, then delete the Team, it will result in new users being mapped to No Team. They will have to contact you to be assigned to a team in order to use the app.</td></tr></tbody></table>

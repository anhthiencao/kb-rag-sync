...
<table style="border-collapse: collapse; width: 70%;" border="1"><tbody><tr><td style="width: 100%;">The app will ask if you want to automatically start when device start up. It recommended to select yes, unless you want to launch the app yourself every time manually.</td></tr></tbody></table>

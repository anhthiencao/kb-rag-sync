...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><p class="wysiwyg-text-align-center"><strong>NOTE</strong></p></td></tr><tr><td style="border-style: solid; border-width: 1px;">In order to display a Google Calendar, you'll need to grant OptiSigns certain permissions. See our <a href="https://www.optisigns.com/privacy-policy" target="_blank" rel="noopener noreferrer"><strong>Privacy Policy</strong></a><strong> </strong>for what we do with those permissions.</td></tr></tbody></table>

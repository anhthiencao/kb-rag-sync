...
*    If your TV has color saturation issues, run this command to fix it:  
    ...
    wget -O- [https://download.optisignsapp.com/pro-player/change-color-profile.sh](https://download.optisignsapp.com/pro-player/change-color-profile.sh) | bash 
    
*   Overwrite the automatic security updates timing
    
    bash~/bin/override\_upgrade\_schedule.sh 23:30

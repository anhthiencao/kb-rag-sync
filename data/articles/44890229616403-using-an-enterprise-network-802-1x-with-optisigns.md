...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><p class="wysiwyg-text-align-center"><strong>IMPORTANT</strong></p></td></tr><tr><td style="border-style: solid; border-width: 1px;">You'll need to know whether or not you're using <strong>PEAP </strong>or <strong>EAP-TTLS </strong>for your network security protocol. This will determine what sort of certificate to set up on the OptiSigns device.</td></tr></tbody></table>

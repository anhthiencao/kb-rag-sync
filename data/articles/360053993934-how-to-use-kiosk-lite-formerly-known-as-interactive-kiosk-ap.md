...
![chrome\_wUCoFrbwyJ.png](https://support.optisigns.com/hc/article_attachments/28111518265619)

Here's an example of the Close & Nav Bar Styler:

![ApplicationFrameHost\_0xbJVUctOv.png](https://support.optisigns.com/hc/article_attachments/28111518282899)

*   Advanced setting: Returned URL: If you are showing a lead capture form, and when the user finishes the app it automatically returns to playing the standard content. You can paste the URL where the user is redirected to after they submit the form here. (i.e. [https://www.example.com/form123/thank-you](https://www.example.com/form123/thank-you)) then the app detects this URL, and it will return to playing standard content.

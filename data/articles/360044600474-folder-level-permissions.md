...
<table><tbody><tr><td><strong>NOTE</strong></td></tr><tr><td>Folder Permissions options are only available with a <a href="https://www.optisigns.com/pricing" target="_blank" rel="noopener noreferrer"><strong>Pro Plus subscription or higher</strong></a>.&nbsp;</td></tr></tbody></table>
...
<table><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>IMPORTANT</strong></p></td></tr><tr><td>Anything dealing with Folder Security is specific to users with <strong>Owner</strong>, <strong>Super Admin</strong>, or <strong>Admin </strong>permissions within OptiSigns. These roles are managed by your organization.</td></tr></tbody></table>
...
<table><tbody><tr><td><strong>IMPORTANT</strong></td></tr><tr><td>Users which appear here are <em><strong>only users registered on the current team</strong>. </em>Other users on other teams will not appear.</td></tr></tbody></table>
...
*   No other User, team member, or member of any other team _**will even see**_ this folder.
...
All we can do here is restrict access of the Users _**within our own Team**_ to this folder.  
...
![firefox\_vhms9zcYWs.jpg](https://support.optisigns.com/hc/article_attachments/44602796089235)
...
*   Users with only partial access _**will only see the assets or sub-playlists they have access to.**_
*   Playlist Total Time will always display the _**full duration,**_ including invisible assets or sub-playlists:

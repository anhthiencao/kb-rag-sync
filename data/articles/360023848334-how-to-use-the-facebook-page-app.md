...
*   **Page**: Page you want to use (if you have more than 1). 
    ...
    <table><tbody><tr><td><strong>IMPORTANT</strong></td></tr><tr><td>A Facebook asset can only access a single page, and this can only be changed during the creation of the asset. In order to change this, you will need to delete this asset and create a new one.<br><br>If you wish to display multiple Facebook pages, you will need to create individual assets for each one, then use them in a <a href="https://support.optisigns.com/hc/en-us/articles/28295104605843-How-to-Create-Use-Playlists">Playlist</a>.</td></tr></tbody></table>

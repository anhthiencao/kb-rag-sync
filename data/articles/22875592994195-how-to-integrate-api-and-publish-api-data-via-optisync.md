...
<table style="width: 52.9996%;" border="1"><tbody><tr><td style="width: 100%;"><p id="h_01HYP5KK9Y8NPA313WRC263MMQ"><strong>NOTE:</strong> API Integration is only available with a <strong>Pro Plus </strong>plan or higher.</p></td></tr></tbody></table>
...
![firefox\_YNrLQDITUl.png](https://support.optisigns.com/hc/article_attachments/32427362113683)
...
![firefox\_Af1bBuAYxy.png](https://support.optisigns.com/hc/article_attachments/32427378823187)
...
![firefox\_orSTybxxGU.png](https://support.optisigns.com/hc/article_attachments/32427362124563)

Click the **Add Request** button, it will launch the window for you to configure and test the API request.

![firefox\_owER9ex9xQ.png](https://support.optisigns.com/hc/article_attachments/32427362128147)
...
<table style="width: 100%;" border="1"><tbody><tr><td>What is the Difference Between the Two?</td></tr><tr><td><strong>Pre-request:&nbsp; </strong>This is a code snippet normally set the context <em><strong>before</strong></em> the API request. This can be retrieving an authentication token from another API, or to change parameters to allow for more automation.</td></tr><tr><td><strong>Post-request: </strong>A piece of code to apply to the data <em><strong>received from</strong></em> the API request. This code can be used to modify the received data to change how it is displayed on your screens.</td></tr></tbody></table>
...
![firefox\_KkCBvxsPKU.png](https://support.optisigns.com/hc/article_attachments/32427362146707)

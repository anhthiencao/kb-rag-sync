...
<table style="border-collapse: collapse; border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px; text-align: center; width: 100%;"><strong>Google Sheets app is currently only available on Standard and above plans.</strong></td></tr></tbody></table>
...
_**This option is useful if you have private information on your Sheet or want more access and customization of your Sheet in OptiSigns.**_ 
...
![chrome\_QH2y6SgYtm.jpg](https://support.optisigns.com/hc/article_attachments/33979969425299)
...
![chrome\_eX5jtfgERa.jpg](https://support.optisigns.com/hc/article_attachments/33979909659027)
...
*   **Select Sheet:** Allows you to select a single sheet from within the Google Sheet to display
    *   _**Reload Sheets:**_ This will refresh the data to get an updated list Sheets available within that entire document for you to choose from.
...
*   **Speed:** Adjusts the speed at which data transitions. 
    *   _**Slow or 5:**_ 19 seconds
    *   _**Medium or 10:**_ 14 seconds
    *   _**Fast or 15:**_ 9 seconds
...
<table style="border-collapse: collapse; border-style: solid; border-width: 1px;"><tbody><tr style="height: 44px;"><td style="border-style: solid; border-width: 1px; height: 44px; text-align: center; width: 100%;"><strong>App must be saved before changes will appear in Preview.</strong></td></tr></tbody></table>
...
_**This method is useful if you want closer to real-time updates on your screen and a sharing experience similar to Google Docs.**_
...
<table style="border-collapse: collapse; border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px; text-align: center; width: 100%;"><strong>If you do not publish AND share your Sheet, OptiSigns will have you go through the authentication process shown in the previous section. An error message may appear telling you the Sheet isn't published</strong></td></tr></tbody></table>

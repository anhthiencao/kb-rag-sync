...
6.  Click **Upload**  
    **![chrome\_g1LHNs2Iy9.png](https://support.optisigns.com/hc/article_attachments/32753273873683)**  
     
...
<table style="border-collapse: collapse; border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px; width: 100%;"><p class="wysiwyg-text-align-center"><strong>NOTE</strong></p></td></tr><tr><td style="border-style: solid; border-width: 1px;"><p>The first time logging on, your account will require Administrator access.</p><ul><li data-list-item-id="e159f2e9063dc8e084756504fbebfcfec">If you are using a school/work Microsoft account, your IT admin may need to approve the permission the first time.&nbsp;</li><li data-list-item-id="e6964e3d810918097184472039339aa9c">If you see a message like “Need admin approval” or you cannot accept the permission screen, please forward that screen to your IT admin and ask them to approve the OptiSigns access request for your tenant.&nbsp;</li></ul></td></tr></tbody></table>
...
4.  **Select the PowerPoint file** you wish to display.  
    ![chrome\_HitDNka7Wp.png](https://support.optisigns.com/hc/article_attachments/32753273882387)
...
_We do not currently recommend this option unless you are displaying one page._
...
2.  Navigate to the **File** tab, select **Share**, and then click **Embed**.  
    ![chrome\_9JwlCn8RzV.png](https://support.optisigns.com/hc/article_attachments/32753260331411)
3.  **Copy** the HTML embed code.  
    ![chrome\_sR96oO3KwU (1).png](https://support.optisigns.com/hc/article_attachments/32753266835731)
...
8.  Go to **Files/Assets**, then **Apps,** and search for the **PowerPoint Online** app.  
    ![chrome\_fwwQKVRzVI.png](https://support.optisigns.com/hc/article_attachments/32753260348563)
9.  Paste the **modified embed code.**  
    **![chrome\_QYIejECtvB.png](https://support.optisigns.com/hc/article_attachments/32753260352659)**

...
Now your users can log in using the subdomain that you configured (in this case it was [https://advanced.optisigns.net/signIn](https://advanced.optisigns.net/signIn)).

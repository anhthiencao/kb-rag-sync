...
<table><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>IMPORTANT</strong></p></td></tr><tr><td><strong>Rooms </strong>may only be selected <strong>once </strong>during asset creation and cannot be changed later. To do this, simply delete the old asset and create a new one.</td></tr></tbody></table>
...
<table style="margin-left: 0px; margin-right: auto;"><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>NOTE</strong></p></td></tr><tr><td>Be sure to push the app to the intended screen first to test it - the Preview sometimes looks odd.</td></tr></tbody></table>

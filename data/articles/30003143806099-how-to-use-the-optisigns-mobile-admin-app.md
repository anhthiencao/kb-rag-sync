...
<table style="border-collapse: collapse; width: 100%; height: 66px;" border="1"><tbody><tr style="height: 22px;"><td style="width: 100%; height: 22px;"><p><span class="wysiwyg-underline"><strong>Note:</strong></span></p></td></tr><tr style="height: 44px;"><td style="width: 100%; height: 44px;">The Screen section on the OptiSigns Mobile App has some limitations. It cannot preview content before displaying it, and it doesn't have the scheduling features available in the web version.</td></tr></tbody></table>
...
<table style="border-collapse: collapse; width: 100%;" border="1"><tbody><tr><td style="width: 100%;"><strong>Note:</strong> This feature is exclusively available on OptiSigns Android Player. Simply ensure Bluetooth is enabled on your phone to activate this feature.</td></tr></tbody></table>

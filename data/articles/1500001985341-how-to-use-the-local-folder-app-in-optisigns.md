...
<table style="border-collapse: collapse; width: 100%;" border="1"><tbody><tr><td style="width: 100%;"><strong>Note:&nbsp;</strong>The Local folder application only currently supports video and image files.</td></tr></tbody></table>
...
<table style="border-collapse: collapse; width: 100%;" border="1"><tbody><tr><td style="width: 100%;"><strong>IMPORTANT: </strong>To use the Local Folder App on your Android Stick player, make sure its firmware version is 5.17.23 or later.</td></tr></tbody></table>

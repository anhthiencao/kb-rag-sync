...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><strong>NOTE</strong></td></tr><tr><td style="border-style: solid; border-width: 1px;">Hitting <strong>Save </strong>with a blank design triggers a warning letting you know you are saving a blank design. The design will not save.</td></tr></tbody></table>
...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><p class="wysiwyg-text-align-center"><strong>IMPORTANT NOTE</strong></p></td></tr><tr><td style="border-style: solid; border-width: 1px;">How your text is resized is determined by which part of the text you drag from. If you drag <strong>from the sides</strong>, this will <strong>Crop</strong> your text and force it to fit into a smaller range. Dragging <strong>from the corners </strong>will maintain the aspect ratio of the selection and change the size of the font automatically.</td></tr></tbody></table>
...
![firefox\_9GYjGYVRec.gif](https://support.optisigns.com/hc/article_attachments/42278925006227)

<table style="border-style: solid; border-width: 1px; margin-left: 0px; margin-right: auto;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><p class="wysiwyg-text-align-center"><strong>IMPORTANT NOTE</strong></p></td></tr><tr><td style="border-style: solid; border-width: 1px;">How your image is resized is determined by which part of the text you drag from. If you drag <strong>from the sides</strong>, this will <strong>Crop</strong> your image. Dragging <strong>from the corners </strong>will maintain the aspect ratio of the selection and <strong>resize </strong>it automatically.</td></tr></tbody></table>
...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><strong>NOTE</strong></td></tr><tr><td style="border-style: solid; border-width: 1px;">The Undo command can also be performed using <strong>CTRL+Z</strong> on a Windows machine or <strong>Cmd+Z</strong> on a Mac. Redo can be performed using <strong>CTRL+Y</strong> on Windows or <strong>Cmd+SHIFT+Z</strong> on Mac.</td></tr></tbody></table>
...
<table style="border-style: solid; border-width: 1px;"><tbody><tr><td style="border-style: solid; border-width: 1px;"><strong>NOTE</strong></td></tr><tr><td style="border-style: solid; border-width: 1px;">Designer 1.0 is planned to be obsoleted by end-of-year 2025, and all designs created going forward will use Designer 2.0.</td></tr></tbody></table>

...
<table><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>MORE ABOUT ALL CLEAR</strong></p></td></tr><tr><td><p>OptiSigns handles All Clear messages in this way:</p><ol><li data-list-item-id="e71975a6c80b5b5772fbe9d79a0bf1fd1"><p>First, it finds the &lt;responseType&gt; in the message:</p><p><code>&lt;responseType&gt;AllClear&lt;/responseType&gt;</code></p></li><li data-list-item-id="e5028b6f4ad777cb3ee6c9e95e6376803"><p>Then, it checks the &lt;expires&gt;:</p><p><code>&lt;expires&gt;2027-01-31T11:23:46-05:00&lt;/expires&gt;</code></p></li><li data-list-item-id="ee3aeba7edc9293b16bc0d47c0b9c5f26">If AllClear is noted in the response type, it will display the message <strong>until the designated expires time</strong>. If no time is sent, it will default to 60 seconds.</li></ol></td></tr></tbody></table>
...
<table><tbody><tr><td><strong>IMPORTANT</strong></td></tr><tr><td>A common issue we find is the screen displays a "No Content Available" message after users push out the CAP alert using "aeraDesc" an attribute. The solution: if you are not intending to use screen tags to map to location, try changing the Location value from "areaDesc" to any other value, like "areaDesc2".</td></tr></tbody></table>
...
    <identifier>ALERTUS\_2317\_67\_20230131\_162046</identifier>

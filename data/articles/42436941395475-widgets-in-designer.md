...
<table><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>IMPORTANT</strong></p></td></tr><tr><td>Widgets are <em><strong>always </strong></em>overlaid on top of the design. This means that ANY other design elements will end up underneath them. If you want to place something on top of a widget, you'll need to create that as a widget (Overlay Image, etc.).</td></tr></tbody></table>
...
<table><tbody><tr><td><strong>NOTE</strong></td></tr><tr><td>The Format Options menu may be slightly different depending on the asset - for instance, Canva has a slightly different format.</td></tr></tbody></table>
...
<table><tbody><tr><td><strong>NOTE</strong></td></tr><tr><td>The Room can only be selected during the creation of the widget. To change this later, you will have to delete the widget and create a new one.</td></tr></tbody></table>

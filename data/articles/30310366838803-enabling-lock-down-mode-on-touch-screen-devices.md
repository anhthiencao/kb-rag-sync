...
<table style="border-collapse: collapse;"><tbody><tr><td style="width: 100%;"><strong>NOTE:</strong> This will differ depending on the device used. Please see device limitations below.</td></tr></tbody></table>
...
<table style="border-collapse: collapse;"><tbody><tr><td style="width: 100%;">Note: If you unlock the app and then exit it, once you reopen the app, it will be in lock down mode again.&nbsp;</td></tr></tbody></table>
...
<table><tbody><tr><td><p class="wysiwyg-text-align-center"><strong>NOTE</strong></p></td></tr><tr><td>The following instructions will only need to be followed if your Pro Player looks like the one below. Otherwise, follow <a href="#androidplayer">these instructions</a>.</td></tr></tbody></table>

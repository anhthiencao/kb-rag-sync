...
2) Installation from server: if you don't have or don't want to use USB drive, just need to punch in the URL: [https://links.optisigns.com/lg](https://links.optisigns.com/lg) in your SI server TV settings (see detail below)
